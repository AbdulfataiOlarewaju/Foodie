  ...
  return (
    <footer className="py-10 px-4 md:px-20 overflow-hidden  bg-white shadow-2xl dark:bg-color-brown  z-30">
      <div className=' mx-auto flex flex-col md:flex-row justify-between items-start'>
        ...
        <div className='flex item justify-between w-full md:w-1/4'>
          <div className='flex flex-col space-y-1'>
            <h3 className='font-bold text-lg text-orange-600 dark:text-color-yellow'>Quick Link</h3>
          ...
          <div className='flex flex-col space-y-1'>
            <h3 className='font-bold text-lg text-orange-600 dark:text-color-yellow'>Customer Service</h3>
            <ul className='flex flex-col space-y-1 font-bold dark:text-color-yellow'>
      ...
      <div className="w-full md:w-1/3">
             <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Join Our Foodie Community</h3>
