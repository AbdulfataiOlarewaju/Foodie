...
function MenuDetailspage() {
  ...
  return (
    <div className="max-w-screen sm:px-6 py-24 mt-16 dark:bg-color-browwn">
      <div className='flex flex-col lg:flex-row justify-center items-center px-4 gap-8'>
        <div className='w-full lg:w-1/2 lg:p-5 p-0'>
        ...
        <div className='w-full lg:w-1/2 p-5 bg-white rounded-lg lg:mt-32 m-0'>
