  ...
  return (
    <div className="overflow-x-hidden">
      <div className="min-h-screen py-20 bg-cover bg-center dark:bg-gradient-to-br bg-gray-200 shadow-sm dark:bg-color-browwn flex items-center">
        ...
        <div className="container lg:px-16 mb-0 max-w-[1390px] mx-auto grid lg:grid-cols-2 gap-12 mt-12 items-center">
          {/* Text Content */}
          <motion.div
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative overflow-hidden rounded-full shadow-2xl items-center justify-center flex">
              <img
                src={image9}
                alt="Quality Food"
                className="w-full h-auto max-w-[85%] md:max-w-[85%] lg:max-w-full rounded-full shadow-sm transform cursor-pointer hover:scale-105 transition-transform duration-300"
              />
            </div>
          </motion.div>
        </div>
      ...
      <div className="py-36 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-color-browwn dark:to-color-brown">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="container text-center m-auto mb-16 md:mb-20 md:w-1/2"
        >
          <h1 className="tittle">
            <i>Why</i>{" "}
            <span className="span">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-4 md:px-8 lg:px-[90px]"
        >
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center md:flex-row md:items-start gap-20 md:gap-32 py-8  px-4 lg:px-[90px] mx-auto md:mt-32 mt-20"
        >
          <img
            src={image3}
            alt=""
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col items-center md:items-start mt-10 text-orange-700 dark:text-color-yellow">
              ...
              <p className="my-10 max-w-lg text-black font-medium dark:text-white">
                Shop now and join thousands of delighted customers who get
                gourmet meals delivered straight to their door. Experience
                quality, convenience, and exceptional service with every order.
                From farm-fresh ingredients to doorstep delivery, we make
                gourmet dining effortless.
              </p>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="py-36 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-color-browwn dark:to-color-brown lg:px-[27px]"
        >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="py-24 lg:container md:mx-11 mx-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-color-browwn dark:to-color-brown"
        >
          <div className="text-center">
            <h1 className="tittle">
              <i>What Our </i>
